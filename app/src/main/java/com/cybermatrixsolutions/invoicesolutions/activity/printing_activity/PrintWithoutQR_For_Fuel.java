...
public class PrintWithoutQR_For_Fuel extends AppCompatActivity implements View.OnClickListener {
...
String yearsplit;
    ...
    String company_name,address_one,address_three,gst_no,Customer_Name,Driver_Name,fuel_amount,Vehicle_No,Driver_Mobile,RequestId;
    String customer_address,petroldiesel_type;
    ...
    String  line1,pending_request,activity,invoice_no;
    ...
    public void onClick(View arg0) {
        ...
        boolean result= Utility.checkPermission(PrintWithoutQR_For_Fuel.this);
        if(result){
    ...
    private void printBillToDevice(final String address) {
       ...
       final  String terms="Terms & Condition:"+"\n";
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    writeWithFormat(advise_no.getBytes(), new Formatter().bold().get(), Formatter.leftAlign());
                    writeWithFormat(line.getBytes(), new Formatter().bold().get(), Formatter.leftAlign());
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        try {
                            ...
                            Toast.makeText(PrintWithoutQR_For_Fuel.this, "Failed To Print", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void backdialog() {
        final Dialog ab=new Dialog(PrintWithoutQR_For_Fuel.this);
        ab.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
        View view= LayoutInflater.from(PrintWithoutQR_For_Fuel.this).inflate(R.layout.popdialogforpending_request,null,false);
        ...
        clickokhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(PrintWithoutQR_For_Fuel.this,DashboardActivity.class);
                startActivity(i);
                finish();
            }
        });
