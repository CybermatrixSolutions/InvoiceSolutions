...
public class PrintLubeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button.OnClickListener btnScanDeviceOnClickListener
        ...
        public void onClick(View arg0) {
            boolean result = Utility.checkPermission(PrintLubeActivity.this);
            if (result) {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        try {
                            ...
                            Log.e("Class ", "My Exe ", e);
                            Toast.makeText(PrintLubeActivity.this, "Failed To Print", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
...
//                Double with_tax_amount=Double.parseDouble(prices);
    ...
    public void onBackPressed() {
        ...
        final Dialog ab=new Dialog(PrintLubeActivity.this);
        ab.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
        View view= LayoutInflater.from(PrintLubeActivity.this).inflate(R.layout.popdialogforpending_request,null,false);
        ...
        if(pending_request.equals("0")){
            ...
            alertmessage.setText("You have pending request for Fuel.Do you want to proceed?");

        }
        clickokhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(PrintLubeActivity.this,DashboardActivity.class);
                startActivity(i);
                finish();
            }
        });
