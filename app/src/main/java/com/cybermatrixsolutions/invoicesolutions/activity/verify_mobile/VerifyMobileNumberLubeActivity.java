...
public class VerifyMobileNumberLubeActivity extends AppCompatActivity  implements View.OnClickListener {
...
String pending_request,activity,invoice_no;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this,"Failed Resend OTP..!!!!",R.drawable.dont_sign);
            ...
            public void onCodeSent(String verificationId,
                ...
                sendOtp_layout.setVisibility(View.GONE);
                verifyOtp_layout.setVisibility(View.VISIBLE);
                CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this,"OTP has been sent to your Mobile Number..!!!!",R.drawable.successimage);
            }
        };
    }
    ...
    public void onClick(View v) {
        ...
        if (v == send_otp) {
            ...
            if (mobile.length() == 10) {
                ...
                CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this, "Enter Valid 10 digit mobile number..!!!!", R.drawable.dont_sign);
            } }
            if (v == verify) {
                ...
                if (request_id.equals("NoRequest")) {
                    ...
                    if (code.length() == 0) {
                        CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this, "Please Enter Otp..!!!!", R.drawable.dont_sign);
                    } else {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                pb.dismiss();
                                CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this,"Failed..!!!!",R.drawable.dont_sign);
                            }
                        }
                    }
                });
    ...
    private boolean validatePhoneNumber() {
        ...
        call.enqueue(new Callback<CustomerRequest>() {
            ...
            public void onResponse(Call<CustomerRequest> call, Response<CustomerRequest> response) {
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    try {
                        ...
                        Fuel_Lube_List.lube_request_cart.setVisibility(View.GONE);
                    ...
                    CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this,"Transaction Failed..!!!!",R.drawable.dont_sign);
            ...
            public void onFailure(Call<CustomerRequest> call, Throwable t) {
                pb.dismiss();
                CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this,"Server Error ..!!!!",R.drawable.dont_sign);
            }
        });
    }
    private void calluserValidate_Api(String current_driver_mobile, String code, String key) {
        ...
        manager=new PrefsManager(this);
        final ProgressDialog pb = new ProgressDialog(VerifyMobileNumberLubeActivity.this);
        pb.setMessage("Please wait.....");
        pb.show();
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        ...
        call.enqueue(new Callback<CustomerRequest>() {
            ...
            public void onResponse(Call<CustomerRequest> call, Response<CustomerRequest> response) {
                ...
                if(status.equals("success")){
                    Toast.makeText(VerifyMobileNumberLubeActivity.this, "Verified", Toast.LENGTH_SHORT).show();
                    try {
                        CallTransactionApi(manager.getKey("key"),Customer_Code,item_code,itemprice,petrol_or_lube,SlipDetail,petroldiesel_type,petroldiesel_qty,
                                request_id,vehicle_no,Driver_Mobile,Trans_By,cust_type,String.valueOf(total),cust_name,Cust_GST,Cust_mobile,mobile,qty);
                    }catch (Exception e){
                    ...
                    CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this,"Invalid OTP ..!!!!",R.drawable.dont_sign);
                }
            ...
            public void onFailure(Call<CustomerRequest> call, Throwable t) {
                pb.dismiss();
                CustomDialogWithCurrentActivity.customDialogwithsingleButton(VerifyMobileNumberLubeActivity.this,"Connection Failed..!!!!",R.drawable.dont_sign);
